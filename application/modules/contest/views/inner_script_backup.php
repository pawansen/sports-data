...
//     if ($('#no_of_winners').prop('checked')==true){
//     $('#no_of_winners').attr('readonly', true);
// } else {
//     $('#no_of_winners').attr('readonly', false);
// }
...
//for finding the amount to be paid as an entry fees by every team
    ...
    function setTeamFees() {
        ...
        if (contest_sizes != '' && total_winning_amount != '') {
            ...
            //var new_team_entry_fee = team_entry_fee + Math.round(chip) ;
            
            
            
             // alert(new_team_entry_fee);

          //    if(new_team_entry_fee != real_team_entry_fee)
          //  {

          //       var decimal = team_entry_fee.toString().split('.');
          //       var before_decimal = decimal[0];
          //       var after_decimal = decimal[1];
               
          //      if(decimal[1] >= 5)
          //      { 
          //          var team_entry_fee =  before_decimal + 1;
          //          var chip           = Math.round(chip) - 1;
                   
          //          if(chip < 1)
          //          {
          //             var team_entry_fee = real_team_entry_fee ;

          //          }
          //          //alert(team_entry_fee);
          //      }
          //      else{
          //          var team_entry_fee =  before_decimal - 1;
          //          var chip           =  Math.round(chip) + 1;
