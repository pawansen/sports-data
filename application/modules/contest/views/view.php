                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input readonly="true" type="text" class="form-control validate[required]" name="admin_percentage" id="admin_percentage" placeholder="%" value="<?php if(set_value('admin_percentage')){ echo set_value('admin_percentage');}else if(isset($contestDetails['result'][0]->admin_percentage)){ echo $contestDetails['result'][0]->admin_percentage;}  ?>"onkeyup="setTeamFees();">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="chip_value" id="chip_value" placeholder="0" value="<?php if(set_value('chip_value')){ echo set_value('chip_value');}else{ echo isset($contestDetails['result'][0]->chip)?$contestDetails['result'][0]->chip:'';}?>"/>
                                                </div>
                                                <span class="help-block m-b-none col-md-offset-3">
