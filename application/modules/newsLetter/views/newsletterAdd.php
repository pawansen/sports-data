                            ...
                            <label class="col-md-3 control-label">Select Sender</label>
                                            <div class="col-md-9">
                                                <label class="checkbox-inline" for="example-inline-checkbox1">
                                                    <input type="radio" id="example-inline-checkbox1" onclick="changeType('All')" name="userType" value="All"> All Users
                                                </label>
                                                <label class="checkbox-inline" for="example-inline-checkbox2">
                                                    <input type="radio" id="example-inline-checkbox2" onclick="changeType('Selected')" name="userType" value="Selected"> Select Users
                                                </label>
