                                            ...
                                            <div class="menu_sidbar">
                                                <ul id="accordion" class="accordion">
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul class="submenu">
                                                            <li><a class="active" href="<?php echo base_url() . 'front/client_enquiries_draft'; ?>"><i class="fa fa-pencil-square-o icon_menu"></i>Draft</a></li>
                                            ...
                                            <div class="content_desboard">
                                                <div class="row">
                                                    <div class="col-md-12 business_profile">
                                                        ...
                                                        <div class="row">
                             <div class="col-md-12">
                             <h4 class="heading_form">Draft Enquiries </h4>
                             </div>
                             </div>
                                                                ...
                                                                <?php if (!empty($enquiries)) {
                                                                    foreach ($enquiries as $rows) {
                                                                        ...
                                                                        <tr onclick="getDetails('<?php echo $rows->inq_id;?>')">
                                                                            ...
                                                                            <td><a href="<?php echo site_url("front/draft_details/".$rows->inq_id."/".str_replace(" ","-",$rows->company_name));?>"><button class="Interested_right_sidbar">Submit</button></a></td>
                                                                        </tr>
