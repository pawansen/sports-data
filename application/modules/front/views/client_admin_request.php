                        ...
                        <div class="row enquiries_form">
                                    <div class="col-md-6 left_col6">
                                       <div class="input-container readonly_bg_feild">
                                          ...
                                          <input class="input-field" type="text" placeholder="Frist Name" name="rq_fname" value="Norway" readonly>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 right_col6">
                                       <div class="input-container">
                                          ...
                                          <input class="input-field" type="email" placeholder="Email Address" name="rq_email">
                                       </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="row enquiries_form">
                                    ...
                                    <option value="customer service etc">customer service etc </option>
                        </select>
                                    </div>
                                  </div>
