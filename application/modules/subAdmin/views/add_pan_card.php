                        ...
                        <div class="row">
                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="pan_number" id="pan_number" placeholder="<?php echo lang('pan_number');?>" value="<?php if(isset($results->pan_number)){echo $results->pan_number;}else{echo "";}?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="state" id="state" placeholder="<?php echo lang('state');?>" value="<?php if(isset($results->state)){echo $results->state;}else{echo "";} ?>" />
                                    </div>
                             ...
                             <div class="col-md-12" >
                               <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="date_of_birth" id="date_of_birth" readonly="" value="<?php if(isset($results->date_of_birth)){echo $results->date_of_birth;}else{echo "";}?>"/>
                                    </div>
                                </div>
                            </div>
