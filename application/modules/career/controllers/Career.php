...
class Career extends Common_Controller { 
    public $data = array();
    public $file_data = "";
   // public $_table = CMS;
    ...
    public function index() {
        $this->data['parent'] = "Career";
        $this->data['title'] = "Career";
         $option = array('table' => 'career as career',
            'select' => 'career.id,career.full_name,career.email,career.phone,career.subject,career.message,career.image,career.created_date',
           // 'join' => array('users as user'=>'user.id=career.user_id')
            'where' => array('career.delete_status'=> 0),
            );
