<div id="commonModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" role="form" id="editFormAjaxUser" method="post" action="<?php echo base_url('vendors/aadhar_card_add') ?>" enctype="multipart/form-data">
                          ...
                          <div class="col-md-12" >
                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="aadhar_number" id="aadhar_number" placeholder="Aadhar Number" value="<?php if(isset($results->aadhar_number)){echo $results->aadhar_number;}else{echo "";}?>" <?php echo $read_only?>/>
                                    </div>
                                </div>
                            </div>
                              <div class="col-md-12" >
           ...
           <option value="<?php echo $value->id; ?>"  <?php if($state_id==$value->id){ echo 'selected=true';}?> ><?php echo $value->name; ?> </option>
                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Aadhar file</label>
                                    <div class="col-md-9">
                                            <div class="profile_content edit_img">
                                            <div class="file_btn file_btn_logo">
                                            <?php if($read_only!="readonly"){?>
                                              <input type="file"  class="input_img2" id="aadhar_file" name="aadhar_file" style="display: inline-block;">
                                              <?php } ?>
                                              <span class="glyphicon input_img2 logo_btn" style="display: block;">
                                                  <div id="show_company_img"></div>
                                                <span class="ceo_logo">
                                     
                                                    <?php if(!empty($results->aadhar_file)){ ?>
                                                        <img src="<?php echo base_url().$results->aadhar_file;?>">
                                                    <?php }else{ ?>
                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Aadhar Back File</label>
                                    <div class="col-md-9">
                                            <div class="profile_content edit_img">
                                            <div class="file_btn file_btn_logo">
                                             <?php if($read_only!="readonly"){?>
                                              <input type="file"  class="input_img2" id="aadhar_file_back_image" name="aadhar_file_back_image" style="display: inline-block;">
                                              <?php }?>
                                              <span class="glyphicon input_img2 logo_btn" style="display: block;">
                                                  <div id="show_company_img"></div>
                                                <span class="ceo_logo">
                                     
                                                    <?php if(!empty($results->aadhar_file_back_image)){ ?>
                                                        <img src="<?php echo base_url().$results->aadhar_file_back_image;?>">
                                                    <?php }else{ ?>
                                                        <img src="<?php echo base_url().'backend_asset/images/default.jpg';?>">
                                                   <?php }?>
                             ...
                             <?php if(isset($results->id))
                            {
                                ...
                                <input type="hidden" name="exists_image" value="<?php echo $results->aadhar_file;?>" />
                                <input type="hidden" name="exists_id_proof" value="<?php echo $results->aadhar_file_back_image;?>" />
                              <?php   
                            }
                            else{ ?>
