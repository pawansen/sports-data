...
class MY_Loader extends MX_Loader {
    ...
    function front_render($template_name, $vars = array(), $page_script = '') {
        ...
        $this->view('front_includes/front_header.php', $vars);
        $this->view($template_name, $vars);
        $this->view('front_includes/front_footer.php', $vars);
        // $this->view('front_includes/front_script', $vars);
