                ...
                <div class="sidebar-content">
                    ...
                    <ul class="chat-users clearfix">
                        <li>
                            <a href="javascript:void(0)" class="chat-user-online">
                                <span></span>
                                <img src="<?php echo base_url(); ?>backend_asset/admin/<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar12.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="chat-user-online">
                                <span></span>
                                <img src="<?php echo base_url(); ?>backend_asset/admin/<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar15.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="chat-user-online">
                                <span></span>
                                <img src="<?php echo base_url(); ?>backend_asset/admin/<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar10.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="chat-user-online">
                                <span></span>
                                <img src="<?php echo base_url(); ?>backend_asset/admin/<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar4.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="chat-user-away">
                                <span></span>
                                <img src="<?php echo base_url(); ?>backend_asset/admin/<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar7.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="chat-user-away">
                                <span></span>
                                <img src="<?php echo base_url(); ?>backend_asset/admin/<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar9.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="chat-user-busy">
                                <span></span>
                                <img src="<?php echo base_url(); ?>backend_asset/admin/<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar16.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                                <span></span>
                                <img src="<?php echo base_url(); ?>backend_asset/admin/<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar1.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                        ...
                        <li>
                            <a href="javascript:void(0)">
                                <span></span>
                                <img src="<?php echo base_url(); ?>backend_asset/admin/<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar3.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                                <span></span>
                                <img src="<?php echo base_url(); ?>backend_asset/admin/<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar13.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                                <span></span>
                                <img src="<?php echo base_url(); ?>backend_asset/admin/<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar5.jpg" alt="avatar" class="img-circle">
                            </a>
                        </li>
                    </ul>
                    <!-- END Chat Users -->
                    ...
                    <div class="chat-talk display-none">
                        ...
                        <div class="chat-talk-info sidebar-section">
                            ...
                            <img src="<?php echo base_url(); ?>backend_asset/admin/<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar5.jpg" alt="avatar" class="img-circle pull-left">
                    ...
                    <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                        <div class="sidebar-user-avatar">
                            <a href="page_ready_user_profile.php">
                                <img src="<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar2.jpg" alt="avatar">
                            </a>
                        </div>
        ...
        <div id="main-container">
            ...
            <header class="navbar<?php if ($template['header_navbar']) { echo ' ' . $template['header_navbar']; } ?><?php if ($template['header']) { echo ' '. $template['header']; } ?>">
                ...
                <ul class="nav navbar-nav-custom pull-right">
                    ...
                    <li class="dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo base_url(); ?>backend_asset/admin/img/placeholders/avatars/avatar2.jpg" alt="avatar"> <i class="fa fa-angle-down"></i>
                        </a>
