...
switch ($_SERVER['SERVER_NAME']) {
    case 'localhost':
        ...
        define('MW_DB_DATABASE_NAME', 'sale-sports');
        break;
    default:
        define('MW_DB_HOST', 'localhost');
        define('MW_DB_USERNAME', 'ip456789_wp');
        define('MW_DB_PASSWORD', '7Wkk8PeX6d#v');
        define('MW_DB_DATABASE_NAME', 'ip456789_wp');
}
...
define('SUPPORT_EMAIL', 'vendor@admin.com');
